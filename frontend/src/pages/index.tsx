...
export default function Home() {
    ...
    return (
        <div className='scroll-snap-y scroll-snap-mandatory'>
            ...
            <section
                ref={container}
                className='flex flex-col lg:flex-row justify-center items-center h-screen snap-start'
            >
            ...
            <section className='w-full mb-28 mx-auto min-h-175 bg-indigo-50 flex flex-col justify-center items-center sm:min-h-160 md:min-h-170  md:mb-14 lg:pt-20 lg:pb-16 lg:flex-wrap lg:flex-row lg:content-center lg:justify-around lg:min-h-140 2xl:pt-0 xl:pb-0 2xl:items-start 2xl:justify-center 2xl:content-end 2xl:flex-row h-screen snap-start'>
