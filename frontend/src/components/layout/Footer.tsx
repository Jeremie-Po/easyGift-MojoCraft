...
const icons = [
    {
        ...
        viewBox: '0 0 16 16',
        aria: 'lien vers le compte Twitter de Easy Gift',
    },
    {
        id: 'facebook',
        ...
        viewBox: '0 0 16 16',
        aria: 'lien vers le compte Facebook de Easy Gift',
    },
    {
        id: 'instagram',
        ...
        viewBox: '0 0 16 16',
        aria: 'lien vers le compte Instagram de Easy Gift',
    },
    {
        id: 'linkedin',
        ...
        viewBox: '0 0 16 16',
        aria: 'lien vers le compte Linkedin de Easy Gift',
    },
]
            ...
            <div className='flex justify-center flex-col h-full'>
                <div className='space-y-1 flex justify-center items-center w-full mt-3'>
                    ...
                    <div>
                        <Link
                            href='/'
                            className='font-rubik font-bold text-xl text-bgPrimary'
