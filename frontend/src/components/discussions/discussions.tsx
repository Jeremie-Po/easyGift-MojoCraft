...
const Discussions = ({ switchComponent }: any) => {
    ...
    return (
        <>
            ...
            <div className='w-full mt-5 flex-grow flex flex-col gap-6 pb-6 items-center text-primaryMarron lg:mt-20'>
                <section className='flex flex-col gap-6 mb-12 w-11/12 h-5/6 items-center bg-foreground border-2 border-outline rounded-2xl p-8'>
